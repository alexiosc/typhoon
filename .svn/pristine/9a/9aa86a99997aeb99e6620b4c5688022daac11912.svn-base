...
{
      14,     0,    -1,     3,     8,    10,    15,    11,    -1,    16,
      -1,    15,    16,    -1,    17,    10,    18,    11,    -1,     4,
       8,     7,     9,    -1,    19,    -1,    18,    19,    -1,     8,
      12,    -1,    20,    10,    18,    11,    12,    -1,    21,     8,
      -1,     5,    -1,     6,    -1
};
...
{
       0,   131,   131,   134,   135,   138,   144,   157,   158,   161,
     167,   173,   181,   182
};
#endif
...
{
  "$end", "error", "$undefined", "T_EXPORT", "T_RECORD", "T_STRUCT", 
  "T_UNION", "T_IN", "T_IDENT", "T_STRING", "'{'", "'}'", "';'", 
  "$accept", "export_spec", "record_list", "record", "record_head", 
  "field_list", "field", "struct_head", "struct_or_union", 0
};
#endif
...
{
       0,     0,     0,     0,     1,     0,     0,     0,     3,     0,
       0,     2,     4,     0,     0,    12,    13,     0,     0,     7,
       0,     0,     6,     9,     5,     8,     0,    11,     0,     0,
      10
};
...
{
      -1,     5,     7,    -5,   -19,    15,    12,    -3,   -19,    11,
      16,   -19,   -19,    10,    13,   -19,   -19,    14,    -2,   -19,
      17,    20,   -19,   -19,   -19,   -19,    10,   -19,     6,    18,
     -19
};
...
{
      25,     6,     1,    15,    16,     5,    17,     4,    11,    24,
      25,    15,    16,     3,    17,    15,    16,    29,    17,     6,
      10,    13,    22,    14,     0,     0,    23,    26,    27,    12,
      30,     0,     0,     0,    28
};

static const yysigned_char yycheck[] =
{
      18,     4,     3,     5,     6,    10,     8,     0,    11,    11,
      28,     5,     6,     8,     8,     5,     6,    11,     8,     4,
       8,    10,     9,     7,    -1,    -1,    12,    10,     8,     7,
      12,    -1,    -1,    -1,    26
};
...
{
       0,     3,    14,     8,     0,    10,     4,    15,    16,    17,
       8,    11,    16,    10,     7,     5,     6,     8,    18,    19,
      20,    21,     9,    12,    11,    19,    10,     8,    18,    11,
      12
};
...
#line 145 "exp.y"
    {
						if( cur_rec = GetRecord(yyvsp[-2].s) )
						{
							cur_rec->aux = 1;
...
#line 162 "exp.y"
    {
						if( cur_str )
							cur_fld = GetField(cur_str, yyvsp[-1].s);
					}
    break;
...
#line 174 "exp.y"
    {
						if( cur_str )
							cur_str = GetStruct(cur_str, yyvsp[0].s);
						strnest[++cur_nest] = cur_str;
					}
    break;
